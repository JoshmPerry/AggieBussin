...
### OPEN WEBSITE ###
PATH_TO_WEBDRIVER = "C:\\Users\\aweso\\OneDrive\\Documents\\hack\\chromedriver_win32\\chromedriver.exe"
...
route_numbers = {12,15,22,26,27,31,34,35,36,40,47,48, '47-48', 'N15'}
for route_num in route_numbers:
    time.sleep(0.5)
    URL = 'https://transport.tamu.edu/busroutes/Routes.aspx?r=' + str(route_num)
    driver.get(URL)
